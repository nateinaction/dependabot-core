...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-wordpress"
  spec.summary      = "Provides Dependabot support for Wordpress"
  spec.description  = "Dependabot-Wordpress provides support for bumping Wordpress dependencies via Dependabot. " \
